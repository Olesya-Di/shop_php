...
<div class="container">
  <div class="row justify-content-center">
    <div class="col-12">
      <h1 class="text-center">Товары для мальчиков</h1>
  ...
  getProductsBoy();
  async function getProductsBoy() {
    let response = await fetch("getProductsBoy.php"); // получаем данные методом get
