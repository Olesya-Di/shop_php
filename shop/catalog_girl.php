...
<div class="container">
  <div class="row justify-content-center">
    <div class="col-12">
      <h1 class="text-center">Товары для девочек</h1>
  ...
  getProductsGirl();
  async function getProductsGirl() {
    let response = await fetch("getProductsGirl.php"); // получаем данные методом get
